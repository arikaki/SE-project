...
var DummyQuestion = []interface{}{
	BsonQuestion("why did you choose uf?", []primitive.ObjectID{}, "Chiru", 0, 9, "Education"),
	BsonQuestion("How can modern technology help evolve?", []primitive.ObjectID{}, "SU", 2, 5, "Technology"),
	BsonQuestion("What’s a good investment for 2022?", []primitive.ObjectID{}, "Loki", 9, 18, "Investment"),
	BsonQuestion("What does “G.O.A.T” mean?", []primitive.ObjectID{}, "Nikhil07", 1, 10, "Sports"),
	BsonQuestion("Is milk an organic compound?", []primitive.ObjectID{}, "srikar05", 3, 6, "Chemistry"),
	BsonQuestion("How long are GRE scores valid?", []primitive.ObjectID{}, "Bar", 11, 8, "Education"),
	BsonQuestion("What does “absolute refractive index of glass is 1.5” mean?", []primitive.ObjectID{}, "Srisai9", 8, 3, "Technology"),
	BsonQuestion("Where is Gainesville located?", []primitive.ObjectID{}, "Kalyan09", 11, 11, "General Knowledge"),
	BsonQuestion("Which is the worlds number one cricket team in T20's?", []primitive.ObjectID{}, "Nandigam04", 0, 8, "Sports"),
	BsonQuestion("What is the worlds most spoken language?", []primitive.ObjectID{}, "Bunny", 5, 5, "General Knowledge"),
	BsonQuestion("What does “something being out of” mean?", []primitive.ObjectID{}, "Nag11", 20, 6, "General Knowledge"),
	BsonQuestion("How many egg whites should one eat per day?", []primitive.ObjectID{}, "Amit3", 4, 10, "Health"),
	BsonQuestion("What are examples of demand-side market failures?", []primitive.ObjectID{}, "Nitin36", 6, 6, "Investment"),
	BsonQuestion("What is super bowl?", []primitive.ObjectID{}, "Sachin", 10, 15, "Sports"),
	BsonQuestion("Who is the owner of tesla?", []primitive.ObjectID{}, "Vamsi09", 4, 10, "General Knowledge"),
	BsonQuestion("what is the speed of the bullet train?", []primitive.ObjectID{}, "Nitish12", 18, 8, "Technology"),
}

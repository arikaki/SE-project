...
var DummyQuestion = []interface{}{
	BsonQuestion("why did you choose uf?", []primitive.ObjectID{}, "Chiru", 0, 9, "Education", false, 0),
	BsonQuestion("How can modern technology help evolve?", []primitive.ObjectID{}, "SU", 2, 5, "Technology", false, 2),
	BsonQuestion("What’s a good investment for 2022?", []primitive.ObjectID{}, "Loki", 9, 18, "Investment", false, 1),
	BsonQuestion("What does “G.O.A.T” mean?", []primitive.ObjectID{}, "Nikhil07", 1, 10, "Sports", false, 1),
	BsonQuestion("Is milk an organic compound?", []primitive.ObjectID{}, "srikar05", 3, 6, "Chemistry", false, 2),
	BsonQuestion("How long are GRE scores valid?", []primitive.ObjectID{}, "Bar", 11, 8, "Education", false, 1),
	BsonQuestion("What does “absolute refractive index of glass is 1.5” mean?", []primitive.ObjectID{}, "Srisai9", 8, 3, "Technology", false, 0),
	BsonQuestion("Where is Gainesville located?", []primitive.ObjectID{}, "Kalyan09", 11, 11, "General Knowledge", false, 0),
	BsonQuestion("Which is the worlds number one cricket team in T20's?", []primitive.ObjectID{}, "Nandigam04", 0, 8, "Sports", false, 1),
	BsonQuestion("What is the worlds most spoken language?", []primitive.ObjectID{}, "Bunny", 5, 5, "General Knowledge", false, 0),
	BsonQuestion("What does “something being out of” mean?", []primitive.ObjectID{}, "Nag11", 20, 6, "General Knowledge", false, 0),
	BsonQuestion("How many egg whites should one eat per day?", []primitive.ObjectID{}, "Amit3", 4, 10, "Health", false, 0),
	BsonQuestion("What are examples of demand-side market failures?", []primitive.ObjectID{}, "Nitin36", 6, 6, "Investment", false, 1),
	BsonQuestion("What is super bowl?", []primitive.ObjectID{}, "Sachin", 10, 15, "Sports", false, 0),
	BsonQuestion("Who is the owner of tesla?", []primitive.ObjectID{}, "Vamsi09", 4, 10, "General Knowledge", false, 0),
	BsonQuestion("what is the speed of the bullet train?", []primitive.ObjectID{}, "Nitish12", 18, 8, "Technology", false, 0),
}
